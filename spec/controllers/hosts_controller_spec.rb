...
RSpec.describe HostsController, type: :controller do
  ...
  let(:create_attrs){ {taster_id: taster.id} }
  ...
  context "Taster CRUD" do
    ...
    describe "PUT create" do
      it "creates new host from taster_id" do
        expect{ put :create, params: create_attrs }.to change(Host, :count).by(1)
      end
      it "redirects to edit_user_registration" do
        put :create, params: create_attrs
